...
ALTER TABLE IF EXISTS ONLY public.navigation DROP CONSTRAINT IF EXISTS navigation_pkey;
...
ALTER TABLE IF EXISTS public.navigation ALTER COLUMN id DROP DEFAULT;
...
DROP SEQUENCE IF EXISTS public.navigation_id_seq;
